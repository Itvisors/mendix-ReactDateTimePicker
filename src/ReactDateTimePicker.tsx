...
export default class ReactDateTimePicker extends Component<
    ReactDateTimePickerContainerProps,
    ReactDateTimePickerState
> {
    ...
    render(): ReactNode {
        ...
        if (this.props.picker === "datetimepicker" || this.props.picker === "datepicker") {
            dateFormat =
                typeof this.props.dateFormat === "undefined" || this.props.dateFormat.value === ""
                    ? true
                    : this.props.dateFormat.value;
        }
        ...
        if (this.props.picker === "datetimepicker" || this.props.picker === "timepicker") {
            timeFormat =
                typeof this.props.timeFormat === "undefined" || this.props.timeFormat.value === ""
                    ? true
        ...
        const initialViewDate =
            typeof this.props.initialViewDate === "undefined"
                ...
                ? undefined
                : moment(this.props.initialViewDate.value);
